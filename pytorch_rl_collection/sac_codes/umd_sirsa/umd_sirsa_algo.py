...
def umd_sirsa_algorithm(agent, env, args, np, use_encoder, output_path):
...
###########################################
def run_umd_sirsa_algorithm(args):
    #import robel
    #import gym
    #import pybulletgym
    ...
    from pytorch_rl_collection.sac_codes.umd_sirsa.umd_sirsa_agent import UMD_SIRSA_AGENT
    ...
    agent = UMD_SIRSA_AGENT(states_dim, actions_dim, domains_dim, args, OptimCls=TAdam,
    ...
    output_path = "./trained_agents/{}/{}_{}/{}/".format(
        algo + "_her" + (("_" + model_type) if model_type != "" else ""),# + "_sampleDegenPol",
    ...
    ####
    umd_sirsa_algorithm(agent, env, args, np, use_encoder, output_path)
    if not args.just_run_test_target:
